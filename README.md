...
A Python implementation of **Connect 4** with AI opponents using three different search algorithms: **Minimax**, **Alpha-Beta Pruning**, and **Expectimax**.
...
- **Expectimax**: Accounts for physical uncertainty in disc placement
...
## Game Setup
1. *Select Algorithm*: Choose from Minimax, Alpha-Beta, or Expectimax
